...
console.log("═══ Klovered UAT — 3× ~75-question documents ═══\n");
...
const KB_CHUNKS = [
  ...
  ["Company profile and references", "Klovered Solutions was founded in 2019, is headquartered in Doha with offices in Dubai and London, and employs 85 staff, of whom 60 are in engineering and delivery. Reference customers include three GCC government ministries, two regional banks, and a Fortune 500 logistics firm; contactable references are available under NDA. The company is profitable and carries no external debt. Professional indemnity insurance of $5M and cyber liability insurance of $10M are maintained."],
